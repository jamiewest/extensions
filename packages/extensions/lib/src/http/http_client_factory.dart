...
/// `HttpClientFactoryServiceCollectionExtensions.addHttpClient`. The default
/// factory is registered in the service collection as a singleton.
abstract class HttpClientFactory {
  ...
  /// by [name].
  ///
  /// Each call to [createClient] is guaranteed to return a new [http.BaseClient]
  /// instance. It is generally not necessary to dispose of the [BaseClient]
  /// as the [HttpClientFactory] tracks and disposes resources used by the
  /// [BaseClient].
  ///
