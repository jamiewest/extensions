import '../formats/dataset.dart';
import '../scenario_run_result.dart';
import '../storage/disk_based_response_cache_cache_entry.dart';

extension JsonUtilities on JsonSerializerOptions {JsonTypeInfo<T> getTypeInfo<T>() {
...
class Compact {
  ...
  static JsonTypeInfo<Dataset> get datasetTypeInfo {
    return options.getTypeInfo<Dataset>();
  }
