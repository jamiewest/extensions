...
class LoggerEventIds {
  ...
  static EventId stoppedWithException = const EventId(
    5,
    'StoppedWithException',
  );
  static EventId applicationStartupException = const EventId(
    6,
    'ApplicationStartupException',
  );
  static EventId applicationStoppingException = const EventId(
    7,
    'ApplicationStoppingException',
  );
  static EventId applicationStoppedException = const EventId(
    8,
    'ApplicationStoppedException',
  );
  static EventId backgroundServiceFaulted = const EventId(
    9,
    'BackgroundServiceFaulted',
  );
  static EventId backgroundServiceStoppingHost = const EventId(
    10,
    'BackgroundServiceStoppingHost',
  );
  static EventId hostedServiceStartupFaulted = const EventId(
    11,
