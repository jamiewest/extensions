...
class ServiceDescriptor {
  ...
  String toString() {
    ...
    if (implementationType != null) {
      // ignore: lines_longer_than_80_chars
      return '${_lifetime}ImplementationType: ${implementationType.runtimeType.toString()}';
    }

    if (implementationFactory != null) {
      // ignore: lines_longer_than_80_chars
      //return '${_lifetime}ImplementationFactory: ${implementationFactory.method}';
    }

    // ignore: lines_longer_than_80_chars
    return '${_lifetime}ImplementationInstance: ${implementationInstance.runtimeType.toString()}';
  }
